    ...
    <main className="transaction-page margin-auto mh-100vh">
      ...
      <div className="pi-1">
        <div className="transaction-page__header pb-2">
          <h1 className="extrabold flex-start clr-black">Add Transaction</h1>
          <p className="bold">Hey! {user?.name}👋</p>
          <p className="regular clr-gray-2">Make transaction or split bills </p>
        </div>
        {/* transaction Form */}
        <form action="" className="transaction-page__form mb-1 flex-col gap-1">
          {/* Amount Group */}
          ...
          <div className="transaction-page__form__form-group form-group flex-start personal-group">
            ...
            />
            <label htmlFor="personal" className="form-group__label bold ml-4">
          ...
          {wantToSplit && (
            <div className="transaction-page__form__form-group form-group flex-col  select-friend-group">
              <label htmlFor="select-friend" className="form-group__label">
                Select Friends
              </label>
              <input
                type="search"
                ...
                <div className="selected-friend p-1 bg-clr-gray-4 br-5">
                  <div className="form-group flex-col">
                    <div className="flex-between">
                      <label htmlFor="selected-friend-share">
                        Share of{" "}
                        <span className="bold">{selectedFriend.name}</span>
                      </label>
                      <span
                  ...
                  <div className="form-group mt-8">
                    <button
                      ...
                      onClick={(e) => addFriendsTransaction(e, selectedFriend)}
                    >
                      Add Friend
                    </button>
                  </div>
